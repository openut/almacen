...
use Minsal\PenutBundle\Entity\Empleado;
use Minsal\PenutBundle\Form\EmpleadoType;
...
class EmpleadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MinsalPenutBundle:Empleado')->findAll();
     ...
     * @Method("POST")
     * @Template("MinsalPenutBundle:Empleado:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MinsalPenutBundle:Empleado')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MinsalPenutBundle:Empleado:edit.html.twig")
     */
