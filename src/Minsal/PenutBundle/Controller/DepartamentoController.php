...
use Minsal\PenutBundle\Entity\Departamento;
use Minsal\PenutBundle\Form\DepartamentoType;
...
class DepartamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MinsalPenutBundle:Departamento')->findAll();
     ...
     * @Method("POST")
     * @Template("MinsalPenutBundle:Departamento:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MinsalPenutBundle:Departamento')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MinsalPenutBundle:Departamento:edit.html.twig")
     */
